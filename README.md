...
> [ubuntu-iso-builder-import-pacstall-budgie-theme-layan](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/)
...
| `=` |
| [ubuntu-iso-builder-include-pacstall-budgie-theme-layan](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-budgie-theme-layan) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-theme-layan](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-layan)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-layan.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-theme-layan`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-theme-layan
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-layan/iso-profile/dist`
